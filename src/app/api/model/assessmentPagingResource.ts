...
export class AssessmentPagingResource { 
    ...
    static   getForm(data?: AssessmentPagingResource | AssessmentPagingResource[] | null): FormGroup {
   ...
   * @returns {FormGroup}
   */
  static   getFormGroup(data?: AssessmentPagingResource): FormGroup {
